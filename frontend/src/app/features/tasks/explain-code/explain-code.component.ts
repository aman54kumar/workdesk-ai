...
@Component({
  ...
  template: `
    ...
    <div class="page-wrap">
      ...
      <h2 class="page-title">Explain Code</h2>

      <p class="page-desc">Get a plain-English explanation of any code snippet</p>



      <div class="mb-4">

        <label class="field-label">Paste the code to explain</label>

        <textarea [(ngModel)]="input" (ngModelChange)="onInputChange()" rows="12"
        ...
        @if (showValidation && !input.trim()) {
          ...
          <p class="field-error">Please paste some code before explaining.</p>
      ...
      <!-- Output intentionally in readable (non-monospace) font -->
...
export default class ExplainCodeComponent implements OnInit {
